...
for i=1:Row
   ...
   %         k=errorbar(xax,kalhoreY,kalhorestd,'bo','LineWidth',1, 'MarkerEdgeColor','b',...
%                 'MarkerFaceColor','b',...
%                 'MarkerSize',5); 
	...
	pvalue= chi2cdf(chi2,ndof)
     text(150,0.26, strcat( '\chi^2=', sprintf('%0.3f',chi2), ', p-value=', sprintf('%0.2e',pvalue)    ));
...
saveas(gcf, 'size_Errorbar_GM12878', 'pdf')
