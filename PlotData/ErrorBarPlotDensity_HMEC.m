...
a(1,:,:)=load('./HMEC/Avg_COM_errorbar.dat');
...
for i=1:Row
	...
	h=errorbar(xax,yy,zz,'ro','LineWidth',0.5, 'MarkerEdgeColor','r','MarkerFaceColor','none','MarkerSize',5);hold on 
...
%         set([ht],'FontName','Helvetica','FontSize',18);   
        ...
        %         'MarkerFaceColor','b',...
        %         'MarkerSize',10); 
         k= plot(xax,kalhore(:,2),strcat('b','o'),'MarkerFaceColor','none','MarkerSize',5);
...
saveas(gcf, 'ErrorbarDensity_HMEC', 'pdf')
