...
%          ht=text(80,0.15,strcat('y = ', num2str(coef1) ,'x +',num2str(coef2)),'Color','r');
%         set([ht],'FontName','Helvetica','FontSize',18);        
        ...
        k=errorbar(xax,kalhore(:,2),kalhorestd,'bo','LineWidth',1, 'MarkerEdgeColor','b',...
                'MarkerFaceColor','b',...
                'MarkerSize',5); 
...
%          p=polyfit(xax(SPEP),kalhore(SPEP,2)',1);
%          %yfit=polyval(p,xax(SP:EP));  
%          plot(xax(SPEP),polyval(p,xax(SPEP)),'b-','linewidth',2,'MarkerFaceColor','b')
%          coef1=sprintf('%0.1e',p(1));
%          coef2=sprintf('%0.1f',p(2));
%          ht=text(50,0.9,strcat('y = ', num2str(coef1) ,'x +',num2str(coef2)),'Color','b');
%         set([ht],'FontName','Helvetica','FontSize',18);        
%              
...
saveas(gcf, 'ErrorbarGM12878', 'pdf')
